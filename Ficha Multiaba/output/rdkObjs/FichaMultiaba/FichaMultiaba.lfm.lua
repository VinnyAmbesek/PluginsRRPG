...
function newfrmFM()
    ...
    obj.colorComboBox1:setParent(obj.layout3);
    obj.colorComboBox1:setLeft(50);
    obj.colorComboBox1:setTop(0);
    obj.colorComboBox1:setWidth(45);
    obj.colorComboBox1:setHeight(45);
    ...
    obj.creditBt:setParent(obj.layout3);
    ...
    obj.layout4:setLeft(150);
    obj.layout4:setWidth(1270);
    obj.layout4:setHeight(50);
    obj.layout4:setName("layout4");

    obj.rclAbas = gui.fromHandle(_obj_newObject("recordList"));
    obj.rclAbas:setParent(obj.layout4);
    ...
    obj.boxTexto:setParent(obj.layout5);
    ...
    obj._e_event4 = obj.creditBt:addEventListener("onClick",
        function (self)
    ...
    obj._e_event5 = obj.rclAbas:addEventListener("onSelect",
        function (self)
