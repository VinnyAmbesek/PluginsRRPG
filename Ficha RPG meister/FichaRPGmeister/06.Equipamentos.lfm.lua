...
function newfrmFichaRPGmeister6_svg()
    ...
    obj.edit22:setLeft(64);
    obj.edit22:setTop(190);
    obj.edit22:setWidth(25);
    obj.edit22:setHeight(25);
    obj.edit22:setField("minCorpo");
    ...
    obj.edit23:setField("maxCorpo");
    obj.edit23:setName("edit23");

    obj.label12 = gui.fromHandle(_obj_newObject("label"));
    obj.label12:setParent(obj.layout6);
    obj.label12:setLeft(117);
    ...
    obj.edit25:setWidth(240);
    obj.edit25:setHeight(25);
    obj.edit25:setField("equipamentoPunhos");
    ...
    obj.edit26:setLeft(64);
    obj.edit26:setTop(190);
    obj.edit26:setWidth(25);
    obj.edit26:setHeight(25);
    obj.edit26:setField("minPunhos");
    ...
    obj.edit30:setField("minCintura");
    ...
    obj.edit32:setField("precoCintura");
    ...
    obj.edit33:setField("equipamentoMaos");
    ...
    obj.edit34:setParent(obj.layout9);
    ...
    obj.label19:setText("DEDO I");
    obj.label19:setName("label19");

    obj.edit37 = gui.fromHandle(_obj_newObject("edit"));
    obj.edit37:setParent(obj.layout10);
    obj.edit37:setVertTextAlign("center");
    obj.edit37:setLeft(5);
    obj.edit37:setTop(20);
    obj.edit37:setWidth(240);
    obj.edit37:setHeight(25);
    obj.edit37:setField("equipamentoDedosI");
    ...
    obj.edit39:setParent(obj.layout10);
    ...
    obj.edit40:setField("precoDedosI");
    ...
    obj.edit41:setField("equipamentoDesdosII");
    ...
    obj.edit42:setField("minDesdosII");
    ...
    obj.edit43:setField("maxDesdosII");
    ...
    obj.edit44:setField("precoDesdosII");
    ...
    obj.edit45:setField("equipamentoPes");
    ...
    obj._e_event0 = obj.dataLink1:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minCabeca~=nil and sheet.maxCabeca~=nil and sheet.usosCabeca~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoCabeca);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoCabeca);
            						end;
            					else
            						sheet.usosCabeca = 0;
            					end;
    ...
    obj._e_event2 = obj.dataLink2:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minOlhos~=nil and sheet.maxOlhos~=nil and sheet.usosOlhos~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoOlhos);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoOlhos);
            						end;
            					else
            						sheet.usosOlhos = 0;
            					end;
    ...
    obj._e_event4 = obj.dataLink3:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minPescoco~=nil and sheet.maxPescoco~=nil and sheet.usosPescoco~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoPescoco);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoPescoco);
            						end;
            					else
            						sheet.usosPescoco = 0;
            					end;
    ...
    obj._e_event6 = obj.dataLink4:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minOmbros~=nil and sheet.maxOmbros~=nil and sheet.usosOmbros~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoOmbros);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoOmbros);
            						end;
            					else
            						sheet.usosOmbros = 0;
            					end;
    ...
    obj._e_event8 = obj.dataLink5:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minTorso~=nil and sheet.maxTorso~=nil and sheet.usosTorso~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoTorso);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoTorso);
            						end;
            					else
            						sheet.usosTorso = 0;
            					end;
    ...
    obj._e_event10 = obj.dataLink6:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minCorpo~=nil and sheet.maxCorpo~=nil and sheet.usosCorpo~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoCorpo);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoCorpo);
            						end;
            					else
            						sheet.usosCorpo = 0;
            					end;
    ...
    obj._e_event11 = obj.edit23:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event12 = obj.dataLink7:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minPunhos~=nil and sheet.maxPunhos~=nil and sheet.usosPunhos~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoPunhos);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoPunhos);
            						end;
            					else
            						sheet.usosPunhos = 0;
            					end;
    ...
    obj._e_event13 = obj.edit27:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event14 = obj.dataLink8:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minCintura~=nil and sheet.maxCintura~=nil and sheet.usosCintura~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoCintura);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoCintura);
            						end;
            					else
            						sheet.usosCintura = 0;
            					end;
    ...
    obj._e_event15 = obj.edit31:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event16 = obj.dataLink9:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minMaos~=nil and sheet.maxMaos~=nil and sheet.usosMaos~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoMaos);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoMaos);
            						end;
            					else
            						sheet.usosMaos = 0;
            					end;
    ...
    obj._e_event17 = obj.edit35:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event18 = obj.dataLink10:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minDedosI~=nil and sheet.maxDedosI~=nil and sheet.usosDedosI~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoDedosI);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoDedosI);
            						end;
            					else
            						sheet.usosDedosI = 0;
            					end;
    ...
    obj._e_event19 = obj.edit39:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event20 = obj.dataLink11:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minDesdosII~=nil and sheet.maxDesdosII~=nil and sheet.usosDesdosII~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoDesdosII);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoDesdosII);
            						end;
            					else
    ...
    obj._e_event21 = obj.edit43:addEventListener("onUserChange",
        function (self)
    ...
    obj._e_event22 = obj.dataLink12:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet.minPes~=nil and sheet.maxPes~=nil and sheet.usosPes~=nil then
            						...
            						if mod>0 then
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " recuperou " .. mod .. " usos de " .. sheet.equipamentoPes);
            						end;
            						if 0>mod then
            							mod = mod * -1;
            							mesaDoPersonagem.activeChat:enviarMensagem(sheet.nome .. " gastou " .. mod .. " usos de " .. sheet.equipamentoPes);
            						end;
            					else
            						sheet.usosPes = 0;
            					end;
    ...
    obj._e_event23 = obj.edit47:addEventListener("onUserChange",
        function (self)
